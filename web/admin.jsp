...
<!--                    <input id="search" type="text" placeholder="Search">
                    ...
                    <img class="nav-brand nav-img d-sm-block" id="logo" src="img/logo_2.png" alt="logo">
                    
                           
                    <div class="collapse bg-dark navbar-collapse" id="Navbar">
                        <ul class="navbar-nav mr-auto">
                            
                            <li class="nav-item"><a href="#" id="b1" onclick="DashBoard()">Dashboard</a></li>
                            <li class="nav-item"><a href="#" id="b2" onclick="stdDetails()">Student Details</a></li>
                            <li class="nav-item"><a href="#" id="b4" onclick="Reg()">Register</a></li>
                            <li class="nav-item"><a href="#" id="b3" onclick="payFee()">Pay Fees</a></li>
                           <li class="nav-item d-sm-block"><a href="logout.jsp" id="logout"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
        ...
        <div class="container-fluid">
            ...
            <!--            <div class="row">
                            <div class="col-12 bg-dark left-a">
                                ...
                                <a href="#" id="b3" onclick="payFee()">Pay Fees</a>
                ...
                <div class="col-4" id="std-reg">
                    ...
                    <form id="reg-form" action="StudentRegisteration" method="post">
                        <div  class="form-group">
                            <input class="form-control" name="roll_no" placeholder="Roll No" required>
                        </div>
                        <div  class="form-group">
                            <input class="form-control" name="name" placeholder="Name" required>
                        </div>
                        <div  class="form-group">
                            <input class="form-control" name="fname" placeholder="Father's Name" required>
                        </div>
            ...
            <% String name = request.getParameter("name");
                if (name != null) {
            %>
            <div class="row d-sm-block" id="searchData">
